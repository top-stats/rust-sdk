...
mod blocking_impl {
    ...
    impl BlockingReqwestClient {
        /// Creates a new blocking reqwest client.
        ///
        /// # Errors
        ///
        /// Returns an error if the client cannot be created.
    ...
    impl Default for BlockingReqwestClient {
        fn default() -> Self {
            Self::new().expect("Failed to create default blocking reqwest client")
        }
    }

    impl BlockingHttpClient for BlockingReqwestClient {
